...
const AboutUs = () => {
  const segments = [
    { title: 'Supermart', description: 'Buy products on mart', icon: <ShoppingCart className="w-8 h-8" />, path: "/aarna-mart" },
    { title: 'Gym', description: 'Enhance your fitness', icon: <Dumbbell className="w-8 h-8" />, path: "/aarna-gym" },
    { title: 'Salon', description: 'Salon and spa services', icon: <Scissors className="w-8 h-8" />, path: "/aarna-salon" },
    { title: 'Food Court', description: 'Dining options', icon: <UtensilsCrossed className="w-8 h-8" />, path: "/aarna-foodcourt" },
  ];
  ...
  return (
    <div className="bg-black text-white">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="w-full ">
              <div className="rounded-lg overflow-hidden ml-5 mt-16">
                <img
                  src={about}
                  alt="SNBA Consumers"
                  className=" h-[250px] lg:h-[400px] object-cover"
                />
              </div>
            </div>
            ...
            <div className="w-full space-y-6 mt-5 ">
              ...
              <p className="text-gray-300 text-sm lg:text-lg m-5 text-justify">
      ...
      <div className="py-16">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <p className="text-gray-300 mb-10 text-center max-w-3xl mx-auto">
            One of the key pillars of SNBA Consumers is our unique franchise business model. Whether you are an aspiring entrepreneur or an established business owner, our franchise model provides a fantastic opportunity to grow your business with minimal risk and investment.
          </p>
      ...
      <div className="bg-gradient-to-b from-red-900/20 to-black py-16">
        <div className="container mx-auto px-4 lg:max-w-7xl">
          ...
          <div className="bg-black/70 border border-red-500/20 rounded-xl p-8 shadow-lg">
            ...
            <p className="text-gray-300 mb-8 text-sm lg:text-xl ">
      ...
      <div className="py-16">
        <div className="container mx-auto px-4 max-w-7xl">
          <h2 className="text-3xl font-bold mb-12 text-center">Why Choose SNBA?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={feature.title} className="bg-black border border-red-500/20 rounded-lg p-6 hover:border-red-500/40 transition-all hover:shadow-md hover:shadow-red-600/10">
      ...
      <div className="bg-gradient-to-b from-red-900/20 to-black py-16">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <Link to='/contact-us'>
            <button className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-lg flex items-center mx-auto transition-colors duration-300 font-medium">
