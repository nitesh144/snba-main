...
export default function AnnieGymBlog() {
          ...
          <div className="flex flex-col items-center md:items-start max-w-4xl mx-auto md:mx-0">
            <div className="animate-fadeIn">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-center md:text-left">
                Transform Your <span className="text-red-600">Fitness Journey</span> with Annie Gym
              </h1>
      ...
      <section id="about" className="py-20 bg-gray-800 ">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose <span className="text-red-600">Annie Gym</span>?</h2>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto gap-8 p-5 rounded-xl border border-red-500">
            ...
            <div className="w-full md:w-1/2 mt-8 md:mt-0 text-justify">
              <p className="text-lg mb-6">
                At Annie Gym, we believe fitness is not just about working out, but about building a lifestyle that promotes overall well-being. Our gym provides a welcoming atmosphere where you can focus on your goals while enjoying a variety of fitness services.
              </p>
              <p className="text-lg mb-6">
          ...
          <div className="max-w-4xl mx-auto bg-gray-900 rounded-lg shadow-2xl overflow-hidden">
            <div className="p-8 md:p-12">
              ...
              <div className="text-center">
                ...
                className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105">
                  Sign Up Today
                </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-300">
                "Joining Annie Gym was the best decision I've made for my health. The trainers are knowledgeable and the atmosphere keeps me motivated. I've lost 15kg in just 6 months!"
              </p>
            </div>
            ...
            <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-300">
                "I love the Zumba classes at Annie Gym! The instructors are amazing and the energy is contagious. It never feels like a workout, it's more like a party!"
              </p>
            </div>
            ...
            <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-300">
                "The personal training at Annie Gym is exceptional. My trainer understood my goals and designed a program that has helped me build muscle and increase my strength significantly."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-red-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join Annie Gym today and take the first step towards becoming a healthier, stronger version of yourself!
          </p>
          <button onClick={() => setShowUserForm(true)} 
          className="bg-black text-white hover:bg-gray-900 font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105">
