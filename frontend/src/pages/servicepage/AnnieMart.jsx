            ...
            <div className="min-h-screen bg-black text-white overflow-hidden">
                ...
                <div className="relative h-screen overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row container px-4">
                        <div className="mt-[150px] lg:mt-56 text-left lg:ml-32 lg:text-left lg:max-w-xl" data-aos='fade-up' data-aos-delay='400'>
                            <h1 className="text-3xl lg:text-5xl font-bold mb-6 text-white ">
                                Welcome to <br /> <span className="text-red-600 text-3xl text-outline-white lg:text-5xl ">Annie Mart</span>
                ...
                <div className="py-8 lg:py-24 bg-gradient-to-b from-gray-900 to-black">
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-8 lg:mb-16" data-aos='fade-up'> Membership Benefits</h2>
                ...
                <div className="py-10 bg-gray-800">
                    <div className="container mx-auto px-4">
                        <h2 className="text-2xl lg:text-4xl font-bold text-center mb-8 lg:mb-16" data-aos="fade-up">Why Choose Annie Mart?</h2>
                        <div className="grid grid-cols-1  lg:max-w-5xl mx-auto md:grid-cols-2 lg:grid-cols-2 gap-8">
                            {features.map((feature, index) => (
                                <div key={index} 
                                className="bg-gray-900 p-5 lg:p-9 rounded-lg hover:transform hover:scale-105 transition-transform duration-300 shadow-md shadow-red-500"
                                data-aos="flip-up"
                ...
                <div className="py-10 lg:py-6 bg-gray-800">
                    <div className="container mx-auto px-4">
                        <h2 className="text-2xl lg:text-4xl font-bold text-center  mb-8 lg:mb-16" data-aos="fade-up">Explore Our Categories</h2>
                ...
                <div className="py-8 lg:py-24 bg-gradient-to-b from-gray-800 to-black">
                    <div className="container mx-auto px-4 max-w-5xl ">
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6" data-aos="fade-up">Why We're Different !</h2>
                        <p className="text-sm lg:text-xl text-gray-400 text-center mb-8 lg:mb-16 max-w-3xl mx-auto"
                        data-aos="fade-up" data-aos-delay="200">
                            See how Annie Mart stands out from the competition with our comprehensive offerings and member-first approach.
                        </p>

                        {comparisonData.map((section, index) => (
                            <div key={index} className="mb-8">
                                <h3 className="text-2xl font-bold mb-8 text-center text-red-500" data-aos="fade-up">{section.category}</h3>
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="bg-black border border-gray-800 rounded-lg p-8" data-aos="fade-right" data-aos-delay="200">
                                        <div className="text-xl font-bold mb-6 flex items-center gap-3">
                                            <span className="text-red-500">Annie Mart</span>
                                            <div className="h-1 flex-grow bg-red-500/20 rounded"></div>
                                        </div>
                                        <div className="space-y-4">
                                            {section.AnnieMart.map((feature, idx) => (
                                    ...
                                    <div className="bg-black border border-gray-800 rounded-lg p-8" data-aos="fade-left" data-aos-delay="200">
                                        <div className="text-xl font-bold mb-6 flex items-center gap-3">
                ...
                <div className="py-0 bg-black mb-8">
                    <div className="container mx-auto px-4 text-center">
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-8" data-aos="fade-up">Start Shopping Smarter Today</h2>
                        <p className="text-sm md:text-emerald-50 lg:text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">Join Annie Mart and transform your shopping experience!</p>
                        <button
                            onClick={() => setshowUserForm(true)}
