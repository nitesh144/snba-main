        ...
        <div className="min-h-screen bg-gray-900 overflow-hidden">
                ...
                <div className="relative z-10 container mx-auto px-4 flex items-center lg:ml-8">
                    <div className="mt-[150px] ">
                        <h1 className="text-2xl lg:text-5xl font-bold mb-6 leading-tight text-white">
                            Welcome to <span className='text-red-600 font-bold text-3xl lg:text-5xl text-outline-white'>Aarna Gym</span>
                        ...
                        {/* <h1 className='text-red-600 font-bold text-4xl text-outline-black'>hell0 world</h1> */}
                    </div>
                </div>
            </div>
            ...
            <div className="py-12 lg:py-20 gradient-bg text-white relative overflow-hidden" ref={sectionRef}>
                ...
                <div className="container max-w-7xl mx-auto px-4 relative z-10">
                    ...
                    <div className="text-center mb-20">
                        <h2 className="text-3xl lg:text-6xl font-bold mb-2 fade-in-down text-glow">
                            Why Choose
                            <span className="text-red-500 ml-4">Aarna Gym?</span>
                        </h2>
            ...
            <div className=" bg-black pb-8 lg:pt-8">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-2xl lg:text-4xl font-bold mb-8 text-white">Ready to Transform Your Life?</h2>
