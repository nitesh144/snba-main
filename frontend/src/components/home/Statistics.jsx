  ...
  return (
    <div className=" bg-gradient-to-b from-black to-gray-900 py-10 lg:px-8">
      <div className="lg:max-w-7xl mx-auto text-center" >
        <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-3" data-aos="fade-right">
          Statistics
        </h2>
        ...
        <p className="text-gray-400 max-w-md md:max-w-2xl mx-auto mt-3 text-sm sm:text-base md:text-lg" data-aos="fade-left" data-aos-delay="100">
        ...
        {stats.map((stat, index) => (
          ...
          >
            ...
            <div
              ...
              className="relative m-2 flex items-center justify-center w-8 h-8 md:w-16 md:h-16 rounded-full bg-red-500 border border-white/20 group-hover:scale-110 transition-all duration-300">
                {stat.icon}
              </div>
            </div>
