  ...
  const features = [
    {
      ...
      description: "At Aarna Unisex Salon, our subscription is only ₹99/month. This membership offers incredible value, allowing you to access premium beauty services without breaking the bank.",
    ...
    },
    {
      ...
      description: "Enjoy a generous 75% off on all salon services! Aarna Salon's significant discount allows you to indulge in expert haircuts, stylish makeovers, and relaxing treatments.",
    ...
    },
    {
      ...
      description: "We prioritize quality at Aarna Unisex Salon. Aarna Unisex Salon's skilled professionals use high-quality products and techniques to ensure you receive the best possible care.",
    ...
    },
    {
      icon: <Crown size={32} />,
      title: "Trendy Styles",
      description: "Stay updated with the latest beauty trends! Aarna Salon's stylists are trained in modern techniques and styles, ensuring you leave the salon looking fresh and fabulous.",
  ...
  const testimonials = [
    {
      name: "Sarah Johnson",
      role: "Regular Client",
      content: "The subscription model at Aarna makes premium salon services so affordable. The quality is consistently excellent!",
      rating: 5
    },
    {
      name: "Raj Patel",
